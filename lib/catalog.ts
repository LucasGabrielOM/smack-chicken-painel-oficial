...
export const catalog: CatalogProduct[] = [
  ...
  { id: 3, name: "Balde G 800 g — Tiras Crocantes", description: "800 g de tiras de frango crocantes", priceCents: 7999, category: "Baldes", image: "/balde-tiras.jpeg", featured: true },
  { id: 19, name: "Balde G 800 g — Coxinha da Asa", description: "800 g de coxinhas da asa crocantes", priceCents: 8499, category: "Baldes", image: "/balde-coxinha.jpeg", featured: true },
  ...
  { id: 52, name: "MARMITA SMACK 600g", description: "Uma refeição completa, saborosa e bem servida com 600g ao todo! Frango Smack: filé de sassami crocante e sequinho. Arroz branco soltinho, feijão carioca bem temperado, batata frita crocante. Acompanha salada.", priceCents: 2390, category: "Marmitas", image: "/marmita-smack.jpg", featured: true },
  { id: 53, name: "Smack Original", description: "O clássico da casa: frango crocante em tirinhas, queijo, molho à escolha e pão brioche artesanal. Simples e absurdamente saboroso.", priceCents: 1999, category: "Lanches", image: "/lanche-original.jpeg", featured: true },
  { id: 54, name: "Smack Kids + Batata Smile", description: "Opção especial para os pequenos: pão brioche, frango crocante por fora e macio por dentro, acompanhado de 150 g de batatas smile.", priceCents: 2499, category: "Lanches", image: "/lanche-kids.jpeg", featured: true },
  { id: 55, name: "Smack Fresh", description: "Crocância e frescor no mesmo lanche: frango crocante em tirinhas, alface roxa, tomate fresco, cebola roxa, queijo e molho da sua escolha.", priceCents: 2990, category: "Lanches", image: "/lanche-fresh.jpeg", featured: true },
  { id: 56, name: "Smack Power", description: "Lanche monstro: frango crocante em tirinhas, fatias de bacon super crocante, queijo cheddar derretido e cebola caramelizada.", priceCents: 3999, category: "Lanches", image: "/lanche-power.jpeg", featured: true },
  ...
  { id: 102, name: "Anéis de Cebola Crocantes 250g", description: "Porção de 250 g de anéis de cebola crocantes", priceCents: 2499, category: "Porções", image: "/batata-frita.jpeg" },
  { id: 103, name: "Anéis de Cebola Crocantes 350g", description: "Porção de 350 g de anéis de cebola crocantes", priceCents: 2999, category: "Porções", image: "/batata-frita.jpeg" },
];
