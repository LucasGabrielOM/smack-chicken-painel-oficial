...
export const catalog: CatalogProduct[] = [
  ...
  { id: 8, name: "Polenta Frita 250 g — Tamanho M", description: "Porção de 250 g de polenta frita crocante", priceCents: 1499, category: "Porções", image: "/batata-frita.jpeg" },
  { id: 21, name: "Polenta Frita 350 g — Tamanho G", description: "Porção de 350 g de polenta frita crocante", priceCents: 1999, category: "Porções", image: "/batata-frita.jpeg" },
  ...
  { id: 13, name: "Guaraná Pureza 1 L", description: "Garrafa gelada de 1 litro", priceCents: 900, category: "Bebidas", image: "/coca-lata.jpeg" },
  { id: 14, name: "Coca-Cola 600 ml", description: "Garrafa gelada de 600 ml", priceCents: 900, category: "Bebidas", image: "/coca-lata.jpeg" },
  { id: 15, name: "Stella Artois Long Neck", description: "330 ml · venda somente para maiores de 18", priceCents: 1100, category: "Bebidas", image: "/coca-lata.jpeg" },
  { id: 16, name: "Heineken Long Neck", description: "330 ml · venda somente para maiores de 18", priceCents: 1400, category: "Bebidas", image: "/coca-lata.jpeg" },
  { id: 22, name: "Guaraná Lata 350 ml", description: "Lata gelada", priceCents: 600, category: "Bebidas", image: "/coca-lata.jpeg" },
  { id: 23, name: "Guaraná Zero Lata 350 ml", description: "Lata zero açúcar gelada", priceCents: 600, category: "Bebidas", image: "/coca-zero-lata.jpeg" },
  ...
  { id: 29, name: "Água sem Gás", description: "Água mineral gelada", priceCents: 400, category: "Bebidas", image: "/coca-lata.jpeg" },
  { id: 30, name: "Água com Gás", description: "Água mineral com gás gelada", priceCents: 400, category: "Bebidas", image: "/coca-zero-lata.jpeg" },
  ...
  { id: 34, name: "Coca-Cola 200 ml", description: "Garrafa pequena gelada", priceCents: 400, category: "Bebidas", image: "/coca-lata.jpeg" },
  { id: 35, name: "Coca-Cola Zero 200 ml", description: "Garrafa pequena zero açúcar gelada", priceCents: 400, category: "Bebidas", image: "/coca-zero-lata.jpeg" },
