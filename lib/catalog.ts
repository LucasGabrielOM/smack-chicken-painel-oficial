...
export const catalog: CatalogProduct[] = [
  ...
  { id: 7, name: "Batata Frita 250 g — Tamanho M", description: "Porção de 250 g de batatas fritas crocantes", priceCents: 1499, category: "Porções", image: "/combo.jpeg" },
  { id: 20, name: "Batata Frita 350 g — Tamanho G", description: "Porção de 350 g de batatas fritas crocantes", priceCents: 1999, category: "Porções", image: "/combo.jpeg" },
  { id: 8, name: "Polenta Frita 250 g — Tamanho M", description: "Porção de 250 g de polenta frita crocante", priceCents: 1499, category: "Porções", image: "/balde-mesa.jpeg" },
  { id: 21, name: "Polenta Frita 350 g — Tamanho G", description: "Porção de 350 g de polenta frita crocante", priceCents: 1999, category: "Porções", image: "/balde-mesa.jpeg" },
  ...
  { id: 26, name: "Kapo Uva", description: "Bebida de fruta sabor uva", priceCents: 700, category: "Bebidas", image: "/combo.jpeg" },
  { id: 27, name: "Kapo Morango", description: "Bebida de fruta sabor morango", priceCents: 700, category: "Bebidas", image: "/combo.jpeg" },
  { id: 28, name: "Kapo Laranja", description: "Bebida de fruta sabor laranja", priceCents: 700, category: "Bebidas", image: "/combo.jpeg" },
  { id: 29, name: "Água sem Gás", description: "Água mineral gelada", priceCents: 400, category: "Bebidas", image: "/combo.jpeg" },
  { id: 30, name: "Água com Gás", description: "Água mineral com gás gelada", priceCents: 400, category: "Bebidas", image: "/combo-zero.jpeg" },
  { id: 31, name: "Baly Tradicional", description: "Energético gelado sabor tradicional", priceCents: 1200, category: "Bebidas", image: "/combo.jpeg" },
  { id: 32, name: "Baly Tropical", description: "Energético gelado sabor tropical", priceCents: 1200, category: "Bebidas", image: "/combo.jpeg" },
  { id: 33, name: "Baly Manga", description: "Energético gelado sabor manga", priceCents: 1200, category: "Bebidas", image: "/combo.jpeg" },
  { id: 34, name: "Coca-Cola 200 ml", description: "Garrafa pequena gelada", priceCents: 400, category: "Bebidas", image: "/combo.jpeg" },
  { id: 35, name: "Coca-Cola Zero 200 ml", description: "Garrafa pequena zero açúcar gelada", priceCents: 400, category: "Bebidas", image: "/combo-zero.jpeg" },
